...
import com.dohyundev.ecommerceproject.domain.member.MemberNotFoundException
import com.dohyundev.ecommerceproject.domain.member.MemberRepository
...
class AuthServiceV1(
    ...
    fun reissue(refreshToken: String): TokenPair {
        if (tokenUtil.isExpired(refreshToken)) {
            throw InvalidTokenException("리프레시 토큰이 만료되었습니다.")
        }
